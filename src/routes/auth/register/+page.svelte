<script lang="ts">
	...
	let errors = $state<{ email?: string; password?: string; confirmPassword?: string; form?: string }>({});
	...
	async function handleRegister(e: Event) {
		...
		if (error) {
			if (error.message.toLowerCase().includes('already registered') || error.message.toLowerCase().includes('already exists')) {
				errors = { form: 'Este email já está cadastrado. Tente fazer login.' };
			} else {
		...
		successMessage = 'Conta criada! Verifique seu email para confirmar o cadastro.';
		loading = false;
	}
...
<svelte:head>
	<title>Criar Conta — PedalNation</title>
	<meta name="description" content="Crie sua conta na PedalNation para salvar e gerenciar seus boards de pedaleira." />
</svelte:head>
...
<div class="auth-page">
	<div class="auth-card">
		...
		<p class="auth-subtitle">Comece a montar seus boards hoje</p>
		...
		<p class="auth-footer">
			Já tem uma conta?
			<a href="/auth/login" class="auth-link">Fazer login</a>
		</p>
	</div>
</div>
